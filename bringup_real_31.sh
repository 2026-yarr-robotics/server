...
#
# OnRobot 그리퍼(Compute Box, 192.168.1.1:502)는 같은 USB-이더넷 링크에 물려
# 있으나 192.168.1.0/24 대역이라, 이 인터페이스에 192.168.1.x 보조 IP 가 없으면
# 도달 불가(ping 100% 손실 → WAN 으로 샘). NetworkManager 프로파일
# "Wired connection 2" 에 192.168.1.50/24 를 영구 추가해 두었다:
